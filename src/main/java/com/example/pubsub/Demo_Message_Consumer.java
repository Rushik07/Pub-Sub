...
public class Demo_Message_Consumer implements XMLMessageListener {
    //CountDownLatch here is used for thread sychronization.
    private CountDownLatch latch = new CountDownLatch(1);
    // Logging is done here.
    private static final Logger logger = LoggerFactory.getLogger(Demo_Message_Consumer.class);
